...
<head>
  ...
  <meta name="keywords" content="empleos, desarrolladores, trabajos, tecnología, programación, software" />
  <meta name="author" content="Ghostman" />
...
<body data-username="<?= htmlspecialchars($userName) ?>">
  ...
  <header>
    <div>
      <h1>SerchJobs</h1>
      <nav>
        <a href="serch.html">Buscar</a>
        <a href="#empleos">Empleos</a>
        <a href="#empresas">Empresas</a>
        <!--<a href="#salarios">Salarios</a> tengo que hacer una calculador de saliros dependiendo el trabajo-->
      </nav>
    </div>
      <div id="auth-buttons">
        <a class="btn-gen" href="RegisterV2.html" id="btn-register">Registrarse</a>
        <a class="btn-focus" href="Login.html" id="btn-login">Iniciar sesión</a>
        <button class="btn-focus hidden" id="btn-user"></button>
    </div>
  </header>

  <main>
    <section>
      <img src="assets/background.webp" width="200" />
